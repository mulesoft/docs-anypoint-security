...
//tag::important[]
IMPORTANT: If you edit a secret group, including editing a TLS context, that is currently applied to an API Instance, you must redploy the API Instance to apply the changes.
//end::important[]
