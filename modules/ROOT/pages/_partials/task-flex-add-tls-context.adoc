...
* *Truststore* +
From the drop-down list, select a truststore to store certificates trusted by the client. Only PEM type truststores are visible.
* *Expiration Date* +
...
* *Outbound Settings* +
Optionally, select *Skip server certificate validation* to not support outbound mTLS.
