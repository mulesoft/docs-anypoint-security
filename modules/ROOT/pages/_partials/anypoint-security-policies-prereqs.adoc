...
* Have the Anypoint Security - Edge entitlement for your Anypoint Platform account. If you don't see *Security* in *Management Center*, contact your customer success manager to enable the tokenization service for your account.
