...
. Select *Manage Tokenization Formats* from the Permissions drop-down, and click the blue plus icon image:blue-plus-security.png[]. 
. Select the environment from the Environment drop-down, then select the *Manage Tokenization Services* permission from the Permissions drop-down, and click the blue plus icon image:blue-plus-security.png[].