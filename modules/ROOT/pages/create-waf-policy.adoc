...
image::security-policy-list.png[Create Policy button located above a table containing the name, type, and potential action for 5 security policies.]
...
+
image::waf-rule-set.png[Rule ID range displayed for Scanner detection]
