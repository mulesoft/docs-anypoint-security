...
[NOTE]
 The Flex Gateway documentation also includes the following information as well as how to apply a TLS context to an API Instance. For more information, see xref:gateway::flex-conn-tls-config.adoc[Configuring TLS Context for Flex Gateway Connected Mode].
...
include::partial$task-flex-add-tls-context.adoc[tags=byb;configurationOptions;addContextTitle;addContext;redeploy]
