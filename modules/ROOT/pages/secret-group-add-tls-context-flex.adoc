...
[NOTE]
====
 The Flex Gateway documentation also includes following information as well as how to apply a TLS context to an API Instance
 
 For more information, see xref:gateway::flex-conn-tls-config.adoc[Configuring TLS Context for Flex Gateway Connected Mode].
====
