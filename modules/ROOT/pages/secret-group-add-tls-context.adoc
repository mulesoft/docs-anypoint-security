...
If you choose a Target value of the target Anypoint Security when adding your TLS contex, you can optionally enable client authentication. TLS-enabled clients verify that they trust the server by validating the public certificate against their own set of trusted certificates.
