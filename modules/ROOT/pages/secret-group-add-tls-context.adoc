...
* *Expiration Date* +
Optionally, select the expiration date for the TLS context. The information is consider as metadata of the TLS context. The expiry date of the certificates in the associated keystore or truststore doesn't change.
