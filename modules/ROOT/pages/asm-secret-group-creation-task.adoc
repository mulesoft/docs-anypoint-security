...
[NOTE]
You can add up to a maximum of 15 certificates to the truststore.
...
If you use the Anypoint Security target, you can select keystores and truststores that are either PEM or non-PEM types. Supported non-PEM types include: +
* JKS
* PKCS12
* JCEKS 
