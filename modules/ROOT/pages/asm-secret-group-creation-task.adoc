...
The secret group appears in the *Secret Groups* list view. You can click *Edit* to add the necessary secret types, for example, a keystore or a truststore. 
...
To include a certificate-key pair in a TLS context to encrypt inbound traffic to Runtime Fabric or Mule 4 proxies, you must enable the TLS context. 
