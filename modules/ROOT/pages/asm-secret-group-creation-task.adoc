...
To include a certificate-key pair in a TLS context to encrypt inbound traffic to Runtime Fabric, you must enable the TLS context for your Runtime Fabric.  
...
To configure the TLS context to apply to a Runtime Fabric, select *Anypoint Security*.
