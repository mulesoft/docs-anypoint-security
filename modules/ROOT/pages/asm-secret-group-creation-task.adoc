...
Select this option to enable client authentication. 
+
Secrets Manager also allows you to select custom ciphers.
+
If you are configuring ciphers for use with an HTTPS API Proxy, you can define additional ciphers to use with your proxy instance.
+
