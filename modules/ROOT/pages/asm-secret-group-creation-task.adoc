...
When you edit a secret group, other users are locked out while you edit the necessary security objects. If a user is editing a secret group, the *Edit* button is disabled for other users. 
