...
image::tokenization-flow.png[Flow chart beginning with client information connecting to the API Gateway which has two paths: directly to the Mule App or a two-way connection with the tokenization service.]
