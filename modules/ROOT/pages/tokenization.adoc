...
The way you configure and use the Tokenization service varies according to your implementation. For example, in one scenario, you can add the Tokenization service policy as one of the provided policies for the API Gateway. In another scenario, where extra data processing is required, you can expose the Tokenization endpoint through a Mule app.
