...
This is an example of the `rtfSidSummary` log for a request where sensitive information (tax ID rule) was detected in the payload.
...
You can view the the SID categories and rule IDs in the Anypoint Security Policies RAML. 
