...
Application data validation logic works “as is”. +
...
|*Force token characters in illegal range* |For example, let's say that you have the CCN 1234567890123456 and you have set the *Preserve characters* option to preserve the last four digits and force an invalid one digit with an offset of two from left. The generated token would look similar to: 54D3210987653456.
