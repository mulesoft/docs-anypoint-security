...
* Have permission to manage policies in API Manager and manage tokenization services in Tokenization.
+ 
...
To use tokenization and detokenization policies to configure the tokenization service:
...
For more information, see xref:tokenization-from-a-mule.adoc[Expose Tokenization as a Service Directly to Mule Applications].
