...
[NOTE]
You must download the automatically generated API Gateway Mule application and manually add TLS to the API Gateway Mule application connectors before the tokenization service will work. Tokenization involves sensitive data, and therefore, works only with TLS. +
