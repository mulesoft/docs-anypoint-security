...
image::index-e9021.png[Flow Chart connecting Anypoint Platform services with various Runtime Fabric API Policies and then to respective Mule applications.]
//too long
