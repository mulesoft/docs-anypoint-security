...
. Export the Mule app.
. In Runtime Manager, xref:runtime-manager::deploy-to-runtime-fabric.adoc[deploy the application to Runtime Fabric]. +
[NOTE]
...
* xref:1.13@runtime-fabric::deploy-index.adoc[Deploy Applications and API Proxies to Runtime Fabric]
