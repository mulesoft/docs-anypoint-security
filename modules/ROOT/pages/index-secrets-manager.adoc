...
[NOTE]
====
If you cannot Access Secrets Manager or you receive an error saying `Cannot Create Secret Groups`, you must add the correct permissions in access management.

* If you only need access to the secrets sanager and do not manage Anypoint Runtime Fabrics, add the user permissions under the *Access Management > Permissions > Secrets Manager* tab.
* If you manage Runtime Fabrics, you only need to add the *Manage Runtime Fabric* permission (you don't need to add the *Secrets Manager* permission separately). 
====
