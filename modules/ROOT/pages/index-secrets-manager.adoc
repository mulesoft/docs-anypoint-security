...
* If you need access only to the secrets manager and don't manage instances of Anypoint Runtime Fabric, add the appropriate user permissions in the *Access Management > Permissions > Secrets Manager* tab.
...
* A maximum of 25 secret groups are allowed per Anypoint Platform organization and each secret group can contain a maximum of 350 secrets.
