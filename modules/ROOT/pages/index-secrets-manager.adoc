...
image::secrets-manager-diagram.png[Diagram connecting Secrets Manager tp secret group to service provider to the supported Mule platform in Anypoint platform.]
