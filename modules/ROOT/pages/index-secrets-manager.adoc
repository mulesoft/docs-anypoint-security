...
[NOTE]
If you don't see *Secrets Manager* in *Management Center* when you sign in to your Anypoint Platform account, contact your customer success manager to enable Secrets Manager for your account.
